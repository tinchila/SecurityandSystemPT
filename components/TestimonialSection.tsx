...
const TestimonialSection = () => {
  ...
  return (
    <section className="max-width section-padding">
      <SectionHeading
        title="Whay my coworkers say about me"
        subtitle="Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellendus molestiae fugiat"
      />
      <div>
    ...
    <div className="box flex flex-col gap-5">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-grey-600 text-sm">{review.designation}</p>
        </div>
